...
export declare type YearRangeInputProps = BaseInputProps & DateRelatedProps & MinMaxValueProps & DisableValuesProps;
export declare type YearRangeInputOnChangeData = YearRangeInputProps;
declare class YearRangeInput extends BaseInput<YearRangeInputProps, BaseInputState> {
    ...
    static readonly propTypes: {
        disable: import("prop-types").Requireable<unknown>;
        maxDate: import("prop-types").Requireable<unknown>;
        minDate: import("prop-types").Requireable<unknown>;
        dateFormat: import("prop-types").Requireable<string>;
        initialDate: import("prop-types").Requireable<unknown>;
