...
define(["require", "exports", "lodash/filter", "lodash/range", "lodash/includes", "lodash/isNil", "moment", "react", "../../views/MonthRangeView", "../BasePicker", "./const", "./sharedFunctions"], function (require, exports, filter_1, range_1, includes_1, isNil_1, moment_1, React, MonthRangeView_1, BasePicker_1, const_1, sharedFunctions_1) {
    "use strict";
    ...
    MonthRangeView_1 = __importDefault(MonthRangeView_1);
            ...
            _this.handleChange = function (e, _a) {
                ...
                if (isNil_1.default(start) && isNil_1.default(end)) {
                    ...
                    var selectedDate = localization ?
                        moment_1.default({ year: _this.state.date.year(), month: itemPosition, date: 1 }).locale(localization).endOf('month')
                        : moment_1.default({ year: _this.state.date.year(), month: itemPosition, date: 1 }).endOf('month');
