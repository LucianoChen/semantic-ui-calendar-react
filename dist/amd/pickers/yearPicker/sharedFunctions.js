    ...
    var getDisabledPositions = function (enable, disable, maxDate, minDate, currentDate) {
        ...
        */
        ...
        if (isArray_1.default(enable)) {
            ...
            disabled = disabled.concat(range_1.default(0, const_1.YEARS_IN_YEARRANGE)
        ...
        if (!isNil_1.default(maxDate)) {
            if (maxDate.year() === currentDate.year()) {
                disabled = disabled.concat(range_1.default(maxDate.month() + 1, const_1.YEARS_IN_YEARRANGE));
            }
            if (maxDate.year() < currentDate.year()) {
                disabled = range_1.default(0, const_1.YEARS_IN_YEARRANGE);
            }
        }
