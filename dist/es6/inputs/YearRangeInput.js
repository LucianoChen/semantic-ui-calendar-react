...
import YearRangePicker from '../pickers/yearPicker/YearRangePicker';
...
import { parseArrayOrValue, parseValue, buildValue, parseDatesRange } from './parse';
var YearRangeInput = /** @class */ (function (_super) {
    ...
    function YearRangeInput(props) {
        ...
        _this.getPicker = function () {
            ...
            return (React.createElement(YearRangePicker, { isPickerInFocus: _this.isPickerInFocus, isTriggerInFocus: _this.isTriggerInFocus, inline: _this.props.inline, onCalendarViewMount: _this.onCalendarViewMount, closePopup: _this.closePopup, onChange: _this.handleSelect, dateFormat: dateFormat, initializeWith: buildValue(value, initialDate, localization, dateFormat), start: start, end: end, disable: parseArrayOrValue(disable, dateFormat, localization), maxDate: parseValue(maxDate, dateFormat, localization), minDate: parseValue(minDate, dateFormat, localization), onHeaderClick: function () { return undefined; } }));
        };
    ...
    YearRangeInput.defaultProps = __assign(__assign({}, BaseInput.defaultProps), { dateFormat: 'YYYY', icon: 'calendar' });
    YearRangeInput.propTypes = __assign(__assign(__assign(__assign({}, BaseInputPropTypes), DateRelatedPropTypes), MinMaxValuePropTypes), DisableValuesPropTypes);
