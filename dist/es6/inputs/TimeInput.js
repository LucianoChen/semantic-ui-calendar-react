...
var TimeInput = /** @class */ (function (_super) {
    ...
    function TimeInput(props) {
        ...
        _this.handleSelectUndelayed = function (e, _a) {
            ...
            invoke(_this.props, 'onChange', e, __assign(__assign({}, _this.props), { value: outputTimeString }));
     ...
     */
    TimeInput.defaultProps = __assign(__assign({}, BaseInput.defaultProps), { icon: 'time', timeFormat: '24', disableMinute: false });
    TimeInput.propTypes = __assign(__assign(__assign({}, BaseInputPropTypes), MultimodePropTypes), TimeRelatedPropTypes);
    return TimeInput;
}(BaseInput));
